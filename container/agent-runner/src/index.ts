    ...
    options: {
      ...
      mcpServers: {
        matterbot: {
          ...
          args: [mcpServerPath],
          env: {
            MATTERBOT_CHAT_JID: containerInput.chatJid,
            MATTERBOT_GROUP_FOLDER: containerInput.groupFolder,
            MATTERBOT_IS_MAIN: containerInput.isMain ? '1' : '0',
          },
        },
        ...(sdkEnv.NOTION_TOKEN ? {
          notion: {
